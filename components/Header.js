...
const Header = () => {
    ...
    return (
        <header className='background'>
            <div data-aos="fade-up" data-aos-duration='1000' data-aos-delay='300' className="container text-white py-[50px] xl:py-[150px] xl:pb-[100px] text-center xl:text-left">
